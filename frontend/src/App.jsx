...
import WebsiteAbout from './website_fx/src/pages/about/About'
import WebsitePropFirm from './website_fx/src/pages/prop-firm/Prop-firm'
import WebsitePartnership from './website_fx/src/pages/partnership/Partnership'
import WebsiteContact from './website_fx/src/pages/contact/Contact'
import WebsiteBlog from './website_fx/src/pages/blog/Blog'
import WebsiteLegal from './website_fx/src/pages/legal/Legal'
import WebsiteForexMarket from './website_fx/src/pages/markets/forex/Forex'
import WebsiteIndicesMarket from './website_fx/src/pages/markets/indices/Indices'
import WebsiteCommoditiesMarket from './website_fx/src/pages/markets/commodities/Commodities'
import WebsiteMetalsMarket from './website_fx/src/pages/markets/metals/Metals'
import WebsiteCfdsMarket from './website_fx/src/pages/markets/cfds/Cfds'
import WebsiteAccountTypes from './website_fx/src/pages/accounts/types/Types'
import WebsiteDepositsWithdrawals from './website_fx/src/pages/accounts/deposits-withdrawals/Deposits-withdrawals'
