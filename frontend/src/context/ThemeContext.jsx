...
// Dark mode colors - BlueCrestafx Blue Theme
const darkColors = {
  bgPrimary: '#0A0E14',
  bgSecondary: '#0D1117',
  bgCard: '#161B22',
...
export const ThemeProvider = ({ children }) => {
  ...
  const applyTheme = (colors) => {
    ...
    root.style.setProperty('--color-primary', colors.primary || '#0080FF')
    root.style.setProperty('--color-secondary', colors.secondary || '#00BFFF')
    root.style.setProperty('--color-accent', colors.accent || '#00BFFF')
    root.style.setProperty('--color-bg-primary', colors.bgPrimary || '#0A0E14')
    root.style.setProperty('--color-bg-secondary', colors.bgSecondary || '#0D1117')
    root.style.setProperty('--color-bg-card', colors.bgCard || '#161B22')
