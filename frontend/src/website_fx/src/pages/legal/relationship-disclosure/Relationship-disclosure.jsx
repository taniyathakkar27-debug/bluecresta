      ...
      <main>
        ...
        <section className="py-12 bg-background">
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <p className="text-muted-foreground mb-6">BLUE CRESTA FX acts as a principal in transactions with clients. We are the counterparty to your trades.</p>
            ...
            <p className="text-muted-foreground">BLUE CRESTA FX is regulated by the Financial Services Commission (FSC) of Mauritius.</p>
          </div>
        </section>
