    ...
    <>
      ...
      <main>
        ...
        <section className="py-12 bg-background">
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            <p className="text-muted-foreground mb-8">BLUE CRESTA FX does not offer services to residents of the following countries and territories due to regulatory restrictions:</p>
