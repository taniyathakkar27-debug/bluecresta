      ...
      <main>
        ...
        <section className="py-12 bg-background">
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <p className="text-muted-foreground mb-6">BLUE CRESTA FX does not charge deposit fees. Withdrawal fees may apply depending on the payment method and amount.</p>
