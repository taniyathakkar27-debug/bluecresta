      ...
      <main>
        ...
        <section className="py-12 bg-background">
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <p className="text-muted-foreground mb-6">BLUE CRESTA FX is committed to identifying, managing, and disclosing conflicts of interest that may arise in the course of providing services to our clients.</p>
            <h2 className="text-xl font-semibold text-foreground mb-4">2. Types of Conflicts</h2>
            <p className="text-muted-foreground mb-6">Conflicts may arise between BLUE CRESTA FX and clients, between different clients, or between employees and clients.</p>
