      ...
      <main>
        ...
        <section className="py-12 bg-background">
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <p className="text-muted-foreground mb-6">By accessing and using BLUE CRESTA FX services, you agree to be bound by these Terms and Conditions.</p>
            ...
            <p className="text-muted-foreground">BLUE CRESTA FX shall not be liable for any indirect, incidental, or consequential damages arising from your use of our services.</p>
          </div>
        </section>
