            ...
            <button
              ...
              className={`px-5 py-2 rounded-full text-sm font-medium transition-all ${
                activeTab === tab
                  ...
                  : "bg-[#0F1628] text-white border border-white/10 hover:bg-[#151D35]"
              }`}
            >
              {tab}
            </button>
        ...
        <div className="bg-[#0F1628] rounded-2xl shadow-sm border border-white/8 overflow-hidden">
          <div className="overflow-x-auto">
            <table className="w-full min-w-[500px]">
              <thead>
                <tr className="bg-[#0A0D1A]/50 border-b border-white/8">
                  <th className="text-left py-3 px-3 sm:py-4 sm:px-6 text-xs sm:text-sm font-semibold text-[#8A94B0]">Instrument</th>
                  <th className="text-right py-3 px-3 sm:py-4 sm:px-6 text-xs sm:text-sm font-semibold text-[#8A94B0]">Bid</th>
                  <th className="text-right py-3 px-3 sm:py-4 sm:px-6 text-xs sm:text-sm font-semibold text-[#8A94B0]">Ask</th>
                  <th className="text-right py-3 px-3 sm:py-4 sm:px-6 text-xs sm:text-sm font-semibold text-[#8A94B0]">Change</th>
                </tr>
              </thead>
              <tbody className="divide-y divide-white/8">
                {filteredPrices.map((instrument, index) => (
                  <tr key={index} className="hover:bg-[#151D35] transition-colors">
                    <td className="py-3 px-3 sm:py-4 sm:px-6">
                      <div className="flex items-center gap-2 sm:gap-3">
                        ...
                        <div>
                          <div className="font-semibold text-white text-sm sm:text-base">{instrument.name}</div>
                          <div className="text-xs text-[#8A94B0]">{instrument.category}</div>
                        </div>
                      </div>
                    </td>
                    <td className="py-3 px-3 sm:py-4 sm:px-6 text-right font-mono text-xs sm:text-sm text-white">
          ...
          {/* Table Footer */}
          <div className="bg-[#0A0D1A]/50 px-6 py-4 border-t border-white/8">
            <p className="text-sm text-[#8A94B0] text-center">
