...
export function PlatformBlurb() {
  return (
    <section className="py-12 lg:py-16 bg-[#0A0D1A] text-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <p className="text-white/90 text-center mb-8 max-w-4xl mx-auto leading-relaxed">
          ...
          BLUE CRESTA FX uses industry-standard trading platforms and live charts to deliver low-latency execution, 
