            ...
            <div className="bg-gradient-to-br from-primary/10 to-primary/5 rounded-3xl p-4 sm:p-8 lg:p-12">
              <div className="grid grid-cols-1 xs:grid-cols-2 gap-3 sm:gap-4">
                {features.map((feature, index) => (
                  <div key={index} className="bg-[#0F1628] border border-white/8 rounded-2xl p-4 sm:p-6 shadow-sm hover:shadow-md transition-shadow">
                    ...
                    <p className="text-xs sm:text-sm font-medium text-white">{feature.title}</p>
                  </div>
                ))}
              </div>
            </div>
