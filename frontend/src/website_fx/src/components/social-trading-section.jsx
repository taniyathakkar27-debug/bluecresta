      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          ...
          <div>
            ...
            <Button size="lg" className="pill-button pill-button-primary px-8">
          ...
          <div className="relative">
            <div className="bg-gradient-to-br from-primary/10 to-primary/5 rounded-3xl p-6 lg:p-8">
              {/* Trader Cards */}
              <div className="space-y-4">
                {[
                  ...
                  <div key={index} className="bg-[#0F1628] border border-white/8 rounded-xl p-4 flex items-center gap-4 hover:bg-[#151D35] transition-all">
