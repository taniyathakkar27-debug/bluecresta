      ...
      <DialogContent className="sm:max-w-[425px] p-0 overflow-hidden">
        <div className="bg-gradient-to-br from-primary/10 via-primary/5 to-transparent p-6 pb-4">
          <DialogHeader>
            ...
            <DialogDescription className="text-muted-foreground">
              Start your trading journey with BLUE CRESTA FX
            </DialogDescription>
          </DialogHeader>
        </div>
      ...
      <DialogContent className="sm:max-w-[480px] p-0 overflow-hidden max-h-[90vh] overflow-y-auto">
        <div className="bg-gradient-to-br from-primary/10 via-primary/5 to-transparent p-6 pb-4">
          <DialogHeader>
            ...
            <DialogDescription className="text-muted-foreground">
              Join the BLUE CRESTA FX Partner Programme and grow your business with us.
            </DialogDescription>
          </DialogHeader>
        </div>
        ...
        {submitted ? (
          <div className="p-8 flex flex-col items-center text-center gap-4">
            ...
            <p className="text-muted-foreground text-sm max-w-xs">
              Thank you for your interest in partnering with BLUE CRESTA FX. Our partnership team will review your application and reach out within 1–2 business days.
            </p>
          </div>
        ) : (
          <form onSubmit={handleSubmit} className="p-6 pt-4 space-y-4">
