      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="text-center mb-16">
          ...
          <h2 className="text-3xl sm:text-4xl lg:text-5xl font-bold mb-4 text-balance text-gray-900">
            A World of Possibilities — Partner with BLUE CRESTA FX
          </h2>
        ...
        <div className="grid grid-cols-1 xs:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6 mb-12">
          {benefits.map((benefit, index) => (
            <div
              key={index}
              className="bg-white border border-gray-200 rounded-2xl p-4 sm:p-6 hover:shadow-lg transition-all"
            >
              ...
              <h3 className="text-base sm:text-lg font-semibold mb-2 text-gray-900">{benefit.title}</h3>
