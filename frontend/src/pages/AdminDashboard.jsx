...
console.log('Menu items:', menuItems)
  ...
  return (
    <div className={`min-h-screen flex ${isDarkMode ? 'bg-dark-900' : 'bg-gray-100'}`}>
      {/* Collapsible Sidebar */}
      <aside 
        className={`${sidebarExpanded ? 'w-52' : 'w-16'} ${isDarkMode ? 'bg-dark-900 border-gray-800' : 'bg-white border-gray-200'} border-r flex flex-col transition-all duration-300 ease-in-out`}
      ...
      >
        ...
        <div className={`p-2 border-t ${isDarkMode ? 'border-gray-800' : 'border-gray-200'}`}>
          <button 
            ...
            className={`w-full flex items-center gap-3 px-3 py-2.5 transition-colors rounded-lg mb-2 ${isDarkMode ? 'text-gray-400 hover:text-white' : 'text-gray-600 hover:text-gray-900'}`}
      ...
      <main className="flex-1 overflow-auto">
        ...
        <header className={`flex items-center justify-between px-6 py-4 border-b ${isDarkMode ? 'border-gray-800' : 'border-gray-200'}`}>
          <div>
            <h1 className={`text-xl font-semibold ${isDarkMode ? 'text-white' : 'text-gray-900'}`}>Admin Dashboard</h1>
            <p className={`text-sm ${isDarkMode ? 'text-gray-500' : 'text-gray-600'}`}>Manage your platform</p>
          </div>
            ...
            <>
              ...
              <div className="grid grid-cols-4 gap-4 mb-6">
                <div className={`rounded-xl p-5 border ${isDarkMode ? 'bg-dark-800 border-gray-800' : 'bg-white border-gray-200'}`}>
                  ...
                  <p className={`text-sm mb-1 ${isDarkMode ? 'text-gray-500' : 'text-gray-600'}`}>Total Users</p>
                ...
                <div className={`rounded-xl p-5 border ${isDarkMode ? 'bg-dark-800 border-gray-800' : 'bg-white border-gray-200'}`}>
                  ...
                  <p className={`text-sm mb-1 ${isDarkMode ? 'text-gray-500' : 'text-gray-600'}`}>Active Today</p>
                  <p className={`text-2xl font-bold ${isDarkMode ? 'text-white' : 'text-gray-900'}`}>{Math.floor(users.length * 0.7)}</p>
                </div>
                ...
                <div className={`rounded-xl p-5 border ${isDarkMode ? 'bg-dark-800 border-gray-800' : 'bg-white border-gray-200'}`}>
                  ...
                  <p className={`text-sm mb-1 ${isDarkMode ? 'text-gray-500' : 'text-gray-600'}`}>New This Week</p>
                  <p className={`text-2xl font-bold ${isDarkMode ? 'text-white' : 'text-gray-900'}`}>{Math.floor(users.length * 0.3)}</p>
                </div>
                ...
                <div className={`rounded-xl p-5 border ${isDarkMode ? 'bg-dark-800 border-gray-800' : 'bg-white border-gray-200'}`}>
                  ...
                  <p className={`text-sm mb-1 ${isDarkMode ? 'text-gray-500' : 'text-gray-600'}`}>Pending Verification</p>
          ...
          <div className="p-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
              <div className="bg-dark-800 rounded-xl p-6 border border-gray-700">
                ...
                <div className="space-y-2 text-sm">
                  <div className="flex justify-between">
                    ...
                    <span className="text-white">Welcome to BluecrestaFx</span>
                  </div>
                  <div className="flex justify-between">
              ...
              <div className="bg-dark-800 rounded-xl p-6 border border-gray-700">
                ...
                <button className="w-full bg-gradient-to-r from-blue-600 to-cyan-500 text-white px-4 py-2 rounded-lg font-medium hover:from-blue-700 hover:to-cyan-600 flex items-center justify-center gap-2">
                  <Plus size={16} />
                  Create New Template
                </button>
              </div>
