    ...
    return nodes.map((node, idx) => (
      <div key={node._id || idx} className="ml-4 border-l border-gray-700 pl-4 py-2">
        <div className="flex items-center gap-3">
          ...
          <div>
            <p className={`${isDarkMode ? 'text-white' : 'text-gray-900'} text-sm`}>{node.firstName || 'Unknown'}</p>
        ...
        <div className={`${isMobile ? 'p-4' : 'p-6'}`}>
          {loading ? (
            ...
            <div className={`${isMobile ? '' : 'max-w-lg mx-auto'} text-center ${isMobile ? 'py-6' : 'py-12'}`}>
              ...
              <h2 className={`${isMobile ? 'text-xl' : 'text-2xl'} font-bold ${isDarkMode ? 'text-white' : 'text-gray-900'} mb-3`}>Become an Introducing Broker</h2>
              ...
              <button
                onClick={handleApply}
                disabled={applying}
                className="bg-gradient-to-r from-blue-600 to-cyan-500 text-white px-8 py-3 rounded-lg font-semibold hover:from-blue-700 hover:to-cyan-600 disabled:opacity-50"
              >
            ...
            <div className={`${isMobile ? '' : 'max-w-lg mx-auto'} text-center ${isMobile ? 'py-6' : 'py-12'}`}>
              ...
              <h2 className={`${isMobile ? 'text-xl' : 'text-2xl'} font-bold ${isDarkMode ? 'text-white' : 'text-gray-900'} mb-3`}>Application Pending</h2>
            ...
            <div className={`${isMobile ? '' : 'max-w-lg mx-auto'} text-center ${isMobile ? 'py-6' : 'py-12'}`}>
              ...
              <h2 className={`${isMobile ? 'text-xl' : 'text-2xl'} font-bold ${isDarkMode ? 'text-white' : 'text-gray-900'} mb-3`}>Application Rejected</h2>
              <p className={`${isDarkMode ? 'text-gray-400' : 'text-gray-600'} mb-2 text-sm`}>Unfortunately, your IB application was not approved.</p>
                ...
                <div className={`${isDarkMode ? 'bg-dark-800 border-gray-800' : 'bg-white border-gray-200 shadow-sm'} rounded-xl ${isMobile ? 'p-4' : 'p-5'} border mb-4`}>
                  ...
                  <div className={`grid ${isMobile ? 'grid-cols-2 gap-2' : 'grid-cols-5 gap-3'}`}>
                    {levelProgress.allLevels?.map((level) => (
                      ...
                      >
                        {level.isCurrentLevel && (
                          <span className="absolute -top-2 left-1/2 -translate-x-1/2 px-2 py-0.5 bg-gradient-to-r from-blue-600 to-cyan-500 text-white text-xs font-bold rounded">
                            Current
                          </span>
                        )}
                        <div className="flex items-center gap-2 mb-2">
                ...
                <div className={isMobile ? '' : 'max-w-md'}>
                  <div className={`${isDarkMode ? 'bg-dark-800 border-gray-800' : 'bg-white border-gray-200 shadow-sm'} rounded-xl ${isMobile ? 'p-4' : 'p-6'} border`}>
                    ...
                    <button
                      ...
                      className={`w-full bg-gradient-to-r from-blue-600 to-cyan-500 text-white py-2 rounded-lg font-medium hover:from-blue-700 hover:to-cyan-600 disabled:opacity-50 ${isMobile ? 'text-sm' : ''}`}
                    >
                      Request Withdrawal
                    </button>
