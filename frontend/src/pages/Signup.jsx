...
const Signup = () => {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center p-4 sm:p-6 md:p-8 relative overflow-hidden" style={{background: 'linear-gradient(135deg, #020b18 0%, #041428 25%, #061d3a 50%, #04111f 75%, #010a14 100%)'}}>
      ...
      `}</style>
      {[
        { size: 90,  left: '5%',  delay: '0s',   dur: '9s',  c: 'rgba(0,180,255,0.15)' },
        { size: 130, left: '15%', delay: '2.5s', dur: '13s', c: 'rgba(0,100,200,0.12)' },
        { size: 60,  left: '28%', delay: '1s',   dur: '8s',  c: 'rgba(100,210,255,0.18)' },
        { size: 110, left: '42%', delay: '4s',   dur: '12s', c: 'rgba(0,150,230,0.14)' },
        { size: 80,  left: '57%', delay: '0.5s', dur: '10s', c: 'rgba(30,90,200,0.13)' },
        { size: 150, left: '68%', delay: '3s',   dur: '14s', c: 'rgba(0,80,180,0.10)' },
        { size: 70,  left: '78%', delay: '5s',   dur: '11s', c: 'rgba(0,200,240,0.16)' },
        { size: 55,  left: '88%', delay: '1.8s', dur: '7s',  c: 'rgba(80,200,255,0.2)' },
        { size: 100, left: '50%', delay: '6s',   dur: '9s',  c: 'rgba(20,120,220,0.13)' },
      ].map((b, i) => (
        <div
          key={i}
          className="bubble-bg"
          style={{
            ...
            background: `radial-gradient(circle at 30% 30%, ${b.c}, rgba(0,40,120,0.07))`,
