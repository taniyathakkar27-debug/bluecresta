            ...
            <div className={`flex border-b ${isDarkMode ? 'border-gray-800' : 'border-gray-200'}`}>
              ...
              <button
                ...
                className={`allow-investor flex-1 py-3 px-4 text-sm font-medium flex items-center justify-center gap-2 ${
                  ...
                  activeTab === 'positions' ? 'hover:from-blue-700 hover:to-cyan-600 text-white border-b-2 border-blue-700' : isDarkMode ? 'text-gray-400 hover:text-white' : 'text-gray-500 hover:text-gray-900'
              ...
              <button
                ...
                className={`allow-investor flex-1 py-3 px-4 text-sm font-medium flex items-center justify-center gap-2 ${
                  ...
                  activeTab === 'history' ? 'hover:from-blue-700 hover:to-cyan-600 text-white border-b-2 border-blue-700' : isDarkMode ? 'text-gray-400 hover:text-white' : 'text-gray-500 hover:text-gray-900'
              ...
              <button
                ...
                className={`allow-investor flex-1 py-3 px-4 text-sm font-medium flex items-center justify-center gap-2 ${
                  ...
                  activeTab === 'pending' ? 'hover:from-blue-700 hover:to-cyan-600 text-white border-b-2 border-blue-700' : isDarkMode ? 'text-gray-400 hover:text-white' : 'text-gray-500 hover:text-gray-900'
