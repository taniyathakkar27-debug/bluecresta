  ...
  const testimonials = [
    {
      ...
      content: 'BluecrestaFx has transformed my trading experience. The platform is incredibly fast and reliable.',
      rating: 5
    },
    {
      name: 'Sarah Johnson',
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-20">
            <div className="flex items-center gap-3">
              <img src={logo} alt="BluecrestaFx" className="h-14 sm:h-16 md:h-20 object-contain" />
            </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-3xl sm:text-4xl font-bold mb-4">
              Why Choose <span className="bg-gradient-to-r from-cyan-400 to-emerald-400 bg-clip-text text-transparent">BluecrestaFx</span>?
            </h2>
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-gray-400 mb-8">
                Join thousands of successful traders who have chosen BluecrestaFx as their preferred trading platform. 
      ...
      <section id="testimonials" className="py-20 bg-black">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-gray-400 max-w-2xl mx-auto">
              Real stories from real traders who have achieved success with BluecrestaFx
            </p>
          </div>
      ...
      <section className="py-20 bg-gradient-to-r from-cyan-600 via-teal-600 to-emerald-600 relative overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10">
          ...
          <p className="text-white/80 text-lg mb-8 max-w-2xl mx-auto">
            Join BluecrestaFx today and get access to world-class trading tools, 
      ...
      <footer className="bg-gray-900 py-12 border-t border-gray-800">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid md:grid-cols-4 gap-8 mb-8">
            <div>
              <img src={logo} alt="BluecrestaFx" className="h-14 sm:h-16 md:h-20 object-contain mb-4" />
          ...
          <div className="border-t border-gray-800 pt-8 text-center text-gray-400 text-sm">
            <p>© 2026 BluecrestaFx. All rights reserved.</p>
